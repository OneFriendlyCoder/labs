...
class Grader:
    ...
    def run_tests(self):
        ...
        tests = [
            ...
            (7, ''.join([chr(c) for c in [46,115,105,116,101,45,104,101,97,100,101,114,32,45,32,100,105,115,112,108,97,121,58,102,108,101,120]]),
            ...
            (8, ''.join([chr(c) for c in [46,115,105,116,101,45,104,101,97,100,101,114,32,45,32,97,108,105,103,110,45,105,116,101,109,115]]),
                [''.join([chr(c) for c in [46,115,105,116,101,45,104,101,97,100,101,114]])],
                lambda: self.check_value_contains(
                    self.merged_blocks.get(''.join([chr(c) for c in [46,115,105,116,101,45,104,101,97,100,101,114]]), {}),
                    'align-items',
            ...
            (9, ''.join([chr(c) for c in [46,115,105,116,101,45,104,101,97,100,101,114,32,45,32,106,117,115,116,105,102,121,45,99,111,110,116,101,110,116]]),
                [''.join([chr(c) for c in [46,115,105,116,101,45,104,101,97,100,101,114]])],
                lambda: self.check_value_contains(
                    self.merged_blocks.get(''.join([chr(c) for c in [46,115,105,116,101,45,104,101,97,100,101,114]]), {}),
                    'justify-content',
            ...
            (10, ''.join([chr(c) for c in [46,115,105,116,101,45,104,101,97,100,101,114,32,45,32,103,97,112]]),
                [''.join([chr(c) for c in [46,115,105,116,101,45,104,101,97,100,101,114]])],
                lambda: self.check_value_contains(
                    self.merged_blocks.get(''.join([chr(c) for c in [46,115,105,116,101,45,104,101,97,100,101,114]]), {}),
                    'gap',
            ...
            (11, ''.join([chr(c) for c in [46,102,105,108,116,101,114,115,32,45,32,100,105,115,112,108,97,121,58,102,108,101,120]]),
            ...
            (12, ''.join([chr(c) for c in [46,102,105,108,116,101,114,115,32,45,32,103,97,112]]),
                [''.join([chr(c) for c in [46,102,105,108,116,101,114,115]])],
                lambda: self.check_value_contains(
                    self.merged_blocks.get(''.join([chr(c) for c in [46,102,105,108,116,101,114,115]]), {}),
                    'gap',
            ...
            (13, ''.join([chr(c) for c in [46,102,105,108,116,101,114,115,32,45,32,97,108,105,103,110,45,105,116,101,109,115]]),
                [''.join([chr(c) for c in [46,102,105,108,116,101,114,115]])],
                lambda: self.check_filters_align()
            ),
            (14, ''.join([chr(c) for c in [46,102,105,108,116,101,114,115,32,45,32,109,97,114,103,105,110]]),
                [''.join([chr(c) for c in [46,102,105,108,116,101,114,115]])],
                lambda: self.check_value_contains(
                    self.merged_blocks.get(''.join([chr(c) for c in [46,102,105,108,116,101,114,115]]), {}),
                    'margin',
            ...
            (15, ''.join([chr(c) for c in [46,102,105,108,116,101,114,115,32,45,32,102,108,101,120,45,119,114,97,112]]),
                [''.join([chr(c) for c in [46,102,105,108,116,101,114,115]])],
                lambda: self.check_value_contains(
                    self.merged_blocks.get(''.join([chr(c) for c in [46,102,105,108,116,101,114,115]]), {}),
                    'flex-wrap',
